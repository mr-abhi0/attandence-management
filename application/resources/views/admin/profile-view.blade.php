                    ...
                    <table class="tablelist">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <p>@isset($p->civilstatus) {{ $p->civilstatus }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>@isset($p->gender) {{ $p->gender }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>@isset($p->birthplace) {{ $p->birthplace }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p>@isset($p->homeaddress) {{ $p->homeaddress }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>@isset($c->department) {{ $c->department }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>{{ __('Position') }}</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>@isset($p->employmenttype) {{ $p->employmenttype }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p>{{ __('Employement Status') }}</p>
                                </td>
                                <td>
                                    <p>@isset($p->employmentstatus) {{ $p->employmentstatus }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
