            ...
            <div class="col-md-6 float-left">
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <div class="field">
                            <label>{{ __('Upload Joining Form') }}</label>
                            <input class="ui file upload" value="" id="imagefile" name="joining_image" type="file" accept="image/png, image/jpeg, image/jpg" onchange="validateFile()">
                        </div>
                        <br>
                    </div>
                </div>
