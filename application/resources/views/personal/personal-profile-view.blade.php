                    ...
                    <table class="tablelist">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <p>@isset($profile->civilstatus) {{ $profile->civilstatus }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p>@isset($profile->age) {{ $profile->age }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p>{{ __("Height") }} <span class="help">(cm)</span></p>
                                </td>
                                <td>
                                    <p>@isset($profile->height) {{ $profile->height }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p>{{ __("Weight") }} <span class="help">(pounds)</span></p>
                                </td>
                                <td>
                                    <p>@isset($profile->weight) {{ $profile->weight }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p>@isset($profile->gender) {{ $profile->gender }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <p>{{ __("Place of Birth") }}</p>
                                </td>
                                <td>
                                    <p>@isset($profile->birthplace) {{ $profile->birthplace }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p>@isset($profile->homeaddress) {{ $profile->homeaddress }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p>@isset($profile->nationalid) {{ $profile->nationalid }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>@isset($company_data->department) {{ $company_data->department }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>{{ __("Position") }}</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>@isset($profile->employmenttype) {{ $profile->employmenttype }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p>@isset($profile->employmentstatus) {{ $profile->employmentstatus }} @endisset</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p>{{ __("Official Start Date") }}</p>
                                </td>
                                <td>
                                    <p>
